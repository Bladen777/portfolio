                ...
                <section id="img_form_container">
                    ...
                    >
                        <form ref={form} id="contact_form" className={open_contact?  "open_form" : "close_form"} >
                            ...
                            <input className="contact_input" type="text" id="name" name="user_name" placeholder="Your Name" value={contact_name} onChange={(e)=>{set_contact_name(e.target.value)}}></input>
                            {missing_email && <h3>Please Enter your Email</h3>}
                            <input className="contact_input" type="text" id="email" name="user_email" placeholder="Your Email" value={contact_email} onChange={(e)=>{set_contact_email(e.target.value)}}></input>
