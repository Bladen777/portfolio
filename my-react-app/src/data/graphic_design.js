...
This piece as displayed at the 2019 “X Marks the Spot” graphic design show at the One on One Gallery.
    ...
    },
    {
        ...
        date:"2021",      
        description:`
The Art & design community can be at times neglected, so as a part of this we were tasked with bringing awareness to this issue in the community. I chose the route of how boring things are when art and design are ignored. Every year the third-year students get the opportunity to have a poster they design to be used for recruiting new students to the program. I personally have always felt like a bit of a weirdo prior to joining the art and design, so I wanted to use that idea of feeling at home in the program as my main drawing point.
        `,
        link:""
    ...
    },
    {
        ...
        date:"2022",      
        description:`
For the up and coming metal band "Pythonic" I was contacted to redesign their logo. They wanted to take inspiration from the timeless logo of the band "Pantera" which incorperates a heavy and bold typeface that is clearly legible, as well as symmetry. With these elements in mind I got to work, I also wanted to incorperate elements of the Python snake as Pythonic means "of, realting to, or resembling a python". I chose to create all the letters incorperating edges to symbolize the bite of the snake. The "C" inparticular representing the jaw of the snake about to bite, and the "O" loosly representing the eye of the snake. All letters were also designed usuing the golden ratio to create a visually appealing design.
        `,
        link:""
    ...
    },
    {
        ...
        date:"2020",      
        description:`
This project incorperated coming up with a brand identity and develope a logo to encapsulate the identity of the brand. I chose to develope a brand revolving around custom 3D & Sculptural works, "Oddball" was what I came up with a brand that would create and build things that were outside modern design. I wanted the logo to mainly incorperate the loose illustration of a smiling robotic face that would be the standalone maskot for simpler marketing or used in  a variety of different ways.
        `,
        link:""
